#!/usr/bin/env python3
"""
Test MDM deployment with debug logging
"""
...
def main():
    """Test deployment of single MDM form with debug logging."""
    ...
    logger.info('=' * 70)
    logger.info('DEBUG TEST - SINGLE MDM FORM DEPLOYMENT')
    logger.info('=' * 70)
    ...
    try:
        # Create client for jdx4 with debug enabled
        logger.info('Connecting to jdx4...')
        client = JogetClient.from_instance('jdx4', debug=True)
